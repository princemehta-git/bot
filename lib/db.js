...
function createBotDb(bid) {
  ...
  async function getProviderConfig(providerName) {
    ...
    const defaults = { min_deposit_syp: 50, min_cashout_syp: 25000, max_cashout_syp: 250000, cashout_tax_percent: 0, deposit_bonus_percent: 0, min_deposit_usd: null, max_cashout_usd: null };
  ...
  async function setProviderConfig(providerName, fields) {
    ...
    const allowed = ['min_deposit_syp', 'min_cashout_syp', 'max_cashout_syp', 'cashout_tax_percent', 'deposit_bonus_percent', 'min_deposit_usd', 'max_cashout_usd'];
    const updates = {};
  ...
  async function seedPaymentProviders() {
    ...
    await PaymentProvider.bulkCreate([
      ...
      { bot_id: bid, provider_name: 'shamcash', min_deposit_syp: 50, min_cashout_syp: 100000, max_cashout_syp: 2500000, cashout_tax_percent: 0, deposit_bonus_percent: 0, min_deposit_usd: 1, max_cashout_usd: 200 },

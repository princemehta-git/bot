  ...
  if (data === 'create_account') {
    ...
    if (data.startsWith('admin_user_logs_') && isAdminUser(query.from)) {
      ...
      try {
        ...
        const typeLabels = {
          deposit: { syriatel: '📥 إيداع', sham_usd: '📥 إيداع', sham_syp: '📥 إيداع', balance_to_site: '💻 إيداع للموقع', site_to_balance: '💻 سحب من الموقع', spin_wheel: '🎡 ربح العجلة', box_game: '🎮 ربح الصندوق', admin: '👨‍💼 إيداع للحساب بواسطة الإدارة' },
          withdrawal: { syriatel: '📤 سحب', sham_usd: '📤 سحب', sham_syp: '📤 سحب', shamcash: '📤 سحب', balance_to_site: '💻 إيداع للموقع', site_to_balance: '💻 سحب من الموقع', admin: '👨‍💼 سحب من الحساب بواسطة الإدارة' },
        };
        let text = `━━━━━━━━━━━━━━━\n📜 سجل عمليات المستخدم\n━━━━━━━━━━━━━━━\n\n`;

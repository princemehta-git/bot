  ...
  if (data === 'create_account') {
    ...
    async function completeShamAccept(pending, pendingId, query, resolvedBy, channelStatusText, skipAnswer) {
      ...
      if (msgText.startsWith('📤 طلب سحب شام كاش')) {
        try {
          const updatedText = msgText.replace(/⏳ في انتظار الموافقة\.|⚠️ فشل التحويل التلقائي:.*/g, channelStatusText);
    ...
    function handleShamAutoFailure(error, pendingId, query) {
      ...
      if (msgText.startsWith('📤 طلب سحب شام كاش')) {
        ...
        const updatedText = msgText.replace(/⏳ في انتظار الموافقة\.|⚠️ فشل التحويل التلقائي:.*/g, errorLine);
    ...
    async function handleShamAlreadyProcessed(pending, query) {
      ...
      if (msgText.startsWith('📤 طلب سحب شام كاش')) {
        ...
        try {
          const updatedText = msgText.replace(/⏳ في انتظار الموافقة\.|⚠️ فشل التحويل التلقائي:.*/g, statusText);
    ...
    if (data.startsWith('sham_reject_')) {
      ...
      if (msgTextRej.startsWith('📤 طلب سحب شام كاش')) {
        try {
          const updatedTextRej = msgTextRej.replace(/⏳ في انتظار الموافقة\.|⚠️ فشل التحويل التلقائي:.*/g, '❌ تم الرفض.');

...
• شام كاش: ${fmt(sham.max_cashout_syp)} ل.س | $${sham.max_cashout_usd != null ? sham.max_cashout_usd : '—'} USD
• USDT (كريبتو): ${fmtUsd(oxa.max_cashout_syp)}

💵 الحد الأدنى للإيداع:
• سيريتيل كاش: ${fmt(syr.min_deposit_syp)}
• شام كاش: ${fmt(sham.min_deposit_syp)} ل.س | $${sham.min_deposit_usd != null ? sham.min_deposit_usd : '—'} USD
• USDT (كريبتو): ${fmtUsd(oxa.min_deposit_syp)}

🏧 الحد الأدنى للسحب:
• سيريتيل كاش: ${fmt(syr.min_cashout_syp)}
• شام كاش: ${fmt(sham.min_cashout_syp)} ل.س | $${sham.min_cashout_usd != null ? sham.min_cashout_usd : '—'} USD
